...
class WeatherStation {
    ...
    subscribe(observer: Observer): void {
        ...
        console.log('%cNueva aplicación suscrita al sistema meteorológico.');
    }
...
class WeatherApp implements Observer {
    ...
    update(weatherData: string): void {
        console.log(`%c${this.name} %cha recibido notificación del clima: %c${weatherData}`);
    }
}

class ObserverPatternLab2 {
